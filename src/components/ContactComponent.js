...
class Contact extends Component {
    ...
    // // look up docs for how to set this up. this works but Minae does: handleBlur = (field) => () =>{} 
    // handleBlur = (field) => {
    //     this.setState({
                    ...
                    <div className="col-md-10">
                        <LocalForm onSubmit={(values) => this.handleSubmit(values)}>
                            <Row className="form-group" row>
                                ...
                                <Col md={10}>
                                    {/* model attribute in inpput/Context tells redux that value will be stored in state under that value*/}
                                    <Control.text id="firstName" 
                                        model=".firstName" 
                                        name="firstName"
                                    ...
                                    <Errors className="text-danger"
                                        ...
                                        messages={{
                                            ...
                                            maxLength: 'Can be at most 15 characters'
                                        }}
                                    />
                                </Col>
                            </Row >
